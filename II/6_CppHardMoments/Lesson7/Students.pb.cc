...
const uint32_t TableStruct_Students_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Student, marks_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::StudentsGroup, student_),
};
...
const char descriptor_table_protodef_Students_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\000\210\001\001B\r\n\013_patronymic\"L\n\007Student\022\033\n\010fullna"
  "me\030\001 \001(\0132\t.FullName\022\r\n\005marks\030\002 \003(\r\022\025\n\rav"
  "erage_score\030\003 \001(\r\"*\n\rStudentsGroup\022\031\n\007st"
  "udent\030\001 \003(\0132\010.Studentb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Students_2eproto = {
  false, false, 229, descriptor_table_protodef_Students_2eproto, "Students.proto", 
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedUInt32Parser(_internal_mutable_marks(), ptr, ctx);
          CHK_(ptr);
...
uint8_t* Student::_InternalSerialize(
  ...
  // uint32 average_score = 3;
  if (this->_internal_average_score() != 0) {
    target = stream->EnsureSpace(target);
...
// @@protoc_insertion_point(message_byte_size_start:Student)
  ...
  // uint32 average_score = 3;
  if (this->_internal_average_score() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_average_score());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Student)
  ...
  if (from._internal_average_score() != 0) {
